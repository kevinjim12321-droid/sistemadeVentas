				...
				<div id="application_settings" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
					<div class="panel-body">
						...
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
							...
							<div class="form-group" data-keyword="<?php echo H(lang('config_enable_quick_expense')) ?>">	
							...
							<div class="form-group" data-keyword="<?php echo H(lang('config_enable_quick_customers')) ?>">	
							...
							<div class="form-group" data-keyword="<?php echo H(lang('config_enable_quick_suppliers')) ?>">	
