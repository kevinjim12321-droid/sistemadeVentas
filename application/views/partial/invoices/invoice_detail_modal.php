<div class="modal fade" id="invoice-modal" tabindex="-1" role="dialog" aria-labelledby="invoiceData" aria-hidden="true">
    <div class="modal-dialog customer-recent-sales">
		<div class="modal-content">
	        ...
	        <div class="modal-body">
				<!-- Form -->
				<?php echo form_open("invoices/add_to_invoice_manual/$invoice_type/$invoice_id",array('id'=>'invoices_form','class'=>'form-horizontal')); ?>
