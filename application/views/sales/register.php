										...
										<tr class="register-item-bottom">
											...
											<td colspan="5">
												<dl class="register-item-extra-details dl-horizontal">
													...
													$available_lots = $cart->is_editing_previous && $cart->get_previous_receipt_id()
														? $this->Inventory_lot->get_available_lots_for_sale_edit($item->item_id, $item->variation_id, $lot_location_id, $cart->get_previous_receipt_id(), $lot_policy)
														: $this->Inventory_lot->get_available_lots($item->item_id, $item->variation_id, $lot_location_id, $lot_policy);
															$lot_source = array();
